...
\LaTeX{} basiert auf der Textsatzsprache TeX von \emph{D. E. Knuth}. Weil TeX
aufgrund der Vielzahl der nötigen Konfigurationsarbeiten
so schwer zu erlernen ist, wurde von anderen, insbesondere von \emph{L. Lamport} 
eine Makrosammlung entwickelt, die viele der Konfigurationsarbeiten durch
Zusammenfassung erleichert. Daher kommt der heutige Name La-TeX, kurz: \LaTeX{}.
Dies ist eine Zusammenfassung von \autocite[1012]{Handbuch}. \\

Weitere Möglichkeiten für Verweise neben autocite sind parencite, textcite, citetitle.
